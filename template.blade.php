    ...
    <div class="flex items-center justify-between bg-gray-200">
        ...
        <div class="w-full flex items-center justify-end">
            <div class="pl-6 py-4 w-2/3 mr-8">
                <input type="text" class="shadow-md outline-none px-3 py-2 rounded-full text-black text-xl w-full" placeholder="Search">
            </div>
            <div><a class="block flex text-gray-500 items-center hover:text-purple-lighter mr-6" href="https://github.com/laravel-livewire/livewire">
