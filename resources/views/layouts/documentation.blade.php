        ...
        <div class="flex-col md:block md:w-1/5 lg:pl-12">
            ...
            <div class="flex flex-wrap justify-around md:pt-8 sm:block">
                ...
                <a style="height: 50px" class="block pb-3 mb-3" href="https://cierra.de" target="_blank">
                    <img class="w-32 md:ml-auto" src="/img/sponsor_cierra.png" alt="Cierra">
                </a>

                <a style="height: 50px" class="block pb-3 mb-3" href="https://www.1043labs.com/" target="_blank">
                    <img class="w-24 md:ml-auto" src="/img/sponsor_1043labs.png" alt="1043 Labs">
                </a>

                <a style="height: 50px" class="block pb-3 mb-3" href="http://jrmerritt.com/" target="_blank">
                    <img class="w-32 md:ml-auto" src="/img/sponsor_jrmerritt.png" alt="JR Merritt">
                </a>

                <a class="block" href="https://trustfactory.bz/" target="_blank">
                    <img class="w-32 md:ml-auto" src="/img/sponsor_trustfactory.png" alt="Trustfactory">
                </a>
            </div>
        </div>
    </div>
