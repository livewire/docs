<div>
    @if ($screencast->code_url)
        ...
        @else
            <!-- A guest or a user that hasn't sponsored yet -->
            <div class="mt-8 flex">
                <button class="text-xs md:text-sm border-2 border-indigo-500 cursor-pointer flex hover:border-indigo-800 hover:text-indigo-800 items-center justify-center px-8 py-2 rounded-full text-indigo-600" wire:click="becomeASponsor">
