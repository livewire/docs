        ...
        <div class="pb-16 pt-6" x-data>
            <div class="rounded overflow-hidden shadow-lg">
                    ...
                    @else
                        <div class="absolute inset-0 bg-indigo-100 overflow-hidden">
                            ...
                            <div class="flex flex-col justify-center items-center relative z-10 h-full w-full">
                                <div class="font-bold mb-8 text-3xl text-center text-white">This video is restrictricted to GitHub sponsors only.</div>
                                <div class="mb-8 text-center text-white text-xl">Your sponsorship helps make videos like these possible! ❤️</div>
                                @guest
                                    <div class="mt-4">
                                        <a class="cursor-pointer border-2 border-white flex hover:border-gray-300 hover:text-gray-400 items-center px-8 py-2 rounded-full shadow text-white" href="/login/github">
                                ...
                                @else
                                    <div>
                                        <a class="cursor-pointer border-2 border-white flex hover:border-gray-300 hover:text-gray-400 items-center px-8 py-2 rounded-full shadow text-white" href="https://github.com/sponsors/calebporzio" target="__blank">
                ...
                <div class="p-4 bg-white">
                    ...
                    @if ($screencast->code_url && (! $screencast->is_paid || (auth()->user() && auth()->user()->is_sponsor)))
                        <div class="mt-6">
