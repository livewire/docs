...
<section class="container max-w-2xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 lg:flex-row lg:mb-24">
        <div class="mt-8">
            ...
            <div class="flex my-10">
                <a href="/docs/getting-started" title="{{ $page->siteName }} getting started" class="bg-blue hover:bg-blue-600 font-normal text-white hover:text-white rounded mr-4 py-2 px-6">Get Started</a>

                <a href="https://jigsaw.tighten.co" title="Jigsaw by Tighten" class="bg-gray-400 hover:bg-gray-600 text-blue-800 font-normal hover:text-white rounded py-2 px-6">About Jigsaw</a>
            </div>
        </div>
    ...
    <div class="md:flex -mx-2 -mx-4">
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            ...
            <h3 id="intro-laravel" class="text-2xl text-blue-800 mb-0">Templating with <br>Laravel's Blade engine</h3>
        ...
        <div class="mb-8 mx-3 px-2 md:w-1/3">
            ...
            <h3 id="intro-markdown" class="text-2xl text-blue-800 mb-0">Use Markdown for <br>content-driven pages</h3>
        ...
        <div class="mx-3 px-2 md:w-1/3">
            ...
            <h3 id="intro-mix" class="text-2xl text-blue-800 mb-0">Compile your assets <br>using Laravel Mix </h3>
