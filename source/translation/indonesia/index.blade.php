...
<div class="bg-white">
    <div style="max-width: 600px; margin: auto" class="pt-16 pb-16 px-12 text-2xl">
        <p>
            <strong class="underline">JavaScript gila hari ini.</strong> Kami menarik tumpukan kode dan kompleksitas ke dalam proyek untuk hal-hal sederhana seperti modem dan pemuatan pemintal. <strong> Tidak harus seperti ini ...</strong>
        </p>
