...
<div class="container mx-auto py-8" style="max-width: 760px;">
    <?php $__currentLoopData = $podcasts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $podcast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="flex mb-8 border-b pb-6">
            ...
            <div class="pl-12">
                <h2 class="text-2xl m-0"><a class="text-blue-800" href="/podcasts/<?php echo e($podcast->filename); ?>"><?php echo e($podcast->title); ?></a></h2>
                <div class="font-bold mb-3 text-gray-500 text-sm">
                    <span>
                        ...
                        <?php echo e($podcast->published_on); ?>
                    ...
                    <span class="ml-3">
                        ...
                        <?php echo e($podcast->duration_in_minutes); ?>

                    </span>
                </div>
                <p class="m-0 text-gray-700 text-base"><?php echo e($podcast->description); ?></p>
            </div>
        </div>
...
<?php echo $__env->make('_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/calebporzio/Documents/Code/sites/livewire-docs/source/podcast/index.blade.php ENDPATH**/ ?>