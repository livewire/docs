...
<template>
 ...
 <?php echo $__env->renderComponent(); ?>
        ...
        <div class="">
<?php $__env->startComponent('_partials.code-component', ['className' => 'App\Http\Livewire\Counter.php', 'viewName' => 'resources/views/livewire/counter.blade.php']); ?> <?php $__env->slot('class'); ?> 
...
<div>
 ...
 <?php $__env->endSlot(); ?> <?php echo $__env->renderComponent(); ?>
        ...
        <ol>
            <li>Vue hears the click because of <code> @click="increment" </code></li>
        ...
        <ol>
            <li>Livewire hears the click because of <code> wire:click="increment" </code></li>
...
<?php echo $__env->make('_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/calebporzio/Documents/Code/sites/livewire-docs/source/index.blade.php ENDPATH**/ ?>