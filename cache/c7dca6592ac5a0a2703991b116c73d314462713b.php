...
<?php $__env->startPush('scripts'); ?>
    <?php if($page->docsearchApiKey && $page->docsearchIndexName): ?>
        ...
        <script type="text/javascript">
            window.something = docsearch({
                apiKey: '<?php echo e($page->docsearchApiKey); ?>',
                indexName: '<?php echo e($page->docsearchIndexName); ?>',
    ...
    <?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/calebporzio/Documents/Code/sites/livewire-docs/source/_nav/search-input.blade.php ENDPATH**/ ?>